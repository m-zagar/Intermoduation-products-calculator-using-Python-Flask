#! C:\Users\Matija\AppData\Local\Programs\Python\Python39\python.exe
...
def plot():
    ...
    (markerline, stemlines, baseline) = plt.stem([w2-w1, (2*w1)-w2, w1, w2, (2*w2)-w1, (2*w1), w1+w2, (2*w2), (3*w1), (2*w1)+w2, (2*w2)+w1, (3*w2)],
                                                 [pow(V, 2) * a2, (3/4) * pow(V, 3) * a3, ((1/4) * V)*(4 * a1 + 9 * a3 * pow(V,2)), ((1/4) * V) * (4 * a1 + 9 * a3 * pow(V,2)),
                                                  (3/4) * pow(V, 3) * a3, (1/2) * pow(V, 2) * a2, pow(V, 2) * a2, (1/2) * pow(V, 2) * a2, (1/4)*pow(V, 3) * a3, (3/4)*pow(V, 3) * a3,
                                                  (3/4)*pow(V, 3) * a3, (1/4)*pow(V, 3) * a3])
    ...
    labels = ['\u03C9\u2082-\u03C9\u2081', '2\u03C9\u2081-\u03C9\u2082', '\u03C9\u2081', '\u03C9\u2082', '2\u03C9\u2082-\u03C9\u2081', '2\u03C9\u2081',
              '\u03C9\u2081+\u03C9\u2082', '2\u03C9\u2082', '3\u03C9\u2081', '2\u03C9\u2081+\u03C9\u2082', '2\u03C9\u2082+\u03C9\u2081', '3\u03C9\u2082']
    ...
    wlabels = ("\u03C9\u2082-\u03C9\u2081", '2\u03C9\u2081-\u03C9\u2082', '\u03C9\u2081', '\u03C9\u2082', '2\u03C9\u2082-\u03C9\u2081',
               '2\u03C9\u2081', '\u03C9\u2081+\u03C9\u2082', '2\u03C9\u2082', '3\u03C9\u2081', '2\u03C9\u2081+\u03C9\u2082', '2\u03C9\u2082+\u03C9\u2081', '3\u03C9\u2082')
    wvalues = (w2-w1, (2*w1)-w2, w1, w2, (2*w2)-w1, (2*w1), w1+w2, (2*w2), (3*w1), (2*w1)+w2, (2*w2)+w1, (3*w2))
    avalues = ('A', pow(V, 2) * a2, (3/4) * pow(V, 3) * a3, ((1/4) * V)*(4 * a1 + 9 * a3 * pow(V,2)), ((1/4) * V) * (4 * a1 + 9 * a3 * pow(V,2)), (3/4) * pow(V, 3) * a3,
               (1/2) * pow(V, 2) * a2, pow(V, 2) * a2, (1/2) * pow(V, 2) * a2, (1/4)*pow(V, 3) * a3, (3/4)*pow(V, 3) * a3, (3/4)*pow(V, 3) * a3, (1/4)*pow(V, 3) * a3)
